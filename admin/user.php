                            ...
                            <table width="100%">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($result_users as $row) { ?>
                                        <tr>
                                            <td><input type="checkbox" value="<?= $row[ 'user_id' ] ?>" name="select">
                                            </td>
                                            <td>
                                                <?= $row[ 'username' ] ?>
                                            </td>
                                            ...
                                            <?php if ($role == 2) { ?>
                                                <td>
                                                    <div class="actions">
                                                        <a
                                                            href="./update/update_user.php?link=user&user_id=<?= $row[ 'user_id' ] ?>">
                                                            <span class="las la-pen" style="color: orange;"></span>
                                                        </a>
                                                        <a href="user.php?link=user&user_id=<?= $row[ 'user_id' ] ?>">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#delete").click(function (e) {
                ...
                var user_id = $('input[name="select"]:checked').map(function () {
                    return $(this).val();
                }).get();

                $.post("./delete/delete_select_user.php", {
                    user_id: user_id
                },
                    function (result) {
                        location.reload();
