                        ...
                        <div class="record-header">
                            ...
                            <div class="browse">
                                ...
                                <div class="action_btn">
                                    ...
                                    <a href="./create/create_category.php?link=category">
                            ...
                            <table width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><span class="las la-sort"></span> TÊN DANH MỤC</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($result as $row) { ?>
                                        <tr>
                                            <td><input type="checkbox" value="<?= $row[ 'category_id' ] ?>" name="select">
                                            </td>
                                            <td>
                                                <?= $row[ 'category_id' ] ?>
                                            </td>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <a
                                                        href="./update/update_category.php?link=category&category_id=<?= $row[ 'category_id' ] ?>">
                                                        <span class="las la-pen" style="color: orange;"></span>
                                                    </a>
                                                    <a
                                                        href="category.php?link=category&category_id=<?= $row[ 'category_id' ] ?>">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#delete").click(function (e) {
                ...
                var category_id = $('input[name="select"]:checked').map(function () {
                    return $(this).val();
                }).get();

                $.post("./delete/delete_select_category.php", {
